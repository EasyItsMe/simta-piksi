...
<div class="login-container">
    ...
    <div class="login-right">
        <div class="auth-form-wrapper">
            ...
            <h3 class="auth-heading">Lupa Password? 🔒</h3>
            <p class="auth-subheading">Masukkan email Anda dan kami akan mengirimkan link untuk mereset password.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}" novalidate>
                ...
                <button type="submit" class="btn btn-login w-100 d-flex justify-content-center align-items-center gap-2 mb-3">
                    Kirim Link Reset Password <i class="bi bi-send"></i>
                </button>
