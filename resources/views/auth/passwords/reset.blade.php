...
<div class="login-container">
    ...
    <div class="login-right">
        <div class="auth-form-wrapper">
            ...
            <h3 class="auth-heading">Buat Password Baru 🔑</h3>
            <p class="auth-subheading">Silakan masukkan password baru Anda.</p>
            ...
            <form method="POST" action="{{ route('password.store') }}" novalidate>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="email" name="email" value="{{ $email ?? old('email') }}" class="form-control border-start-0 ps-1" placeholder="nama@email.com" required autocomplete="email" readonly>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input id="password" type="password" name="password" class="form-control border-start-0 ps-1" placeholder="Minimal 6 karakter" required autofocus>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input id="password-confirm" type="password" name="password_confirmation" class="form-control border-start-0 ps-1" placeholder="Ketik ulang password baru" required>
                    </div>
                </div>
